...
# Example of situation where angle value is greater than 360 - Test 1
print("Test 1 result: " + str(cos_sine_proof(400)))

# Example of situation where angle value is less than 360 - Test 2
print("Test 2 result: ", cos_sine_proof(-10))

# Example of situation where angle value is a string - Test 3
print("Test 3 result: ", cos_sine_proof("c"))

# The right example - Test 4
print("Test 4 result: ", cos_sine_proof(90))
